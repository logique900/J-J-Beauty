    ...
    <div className="max-w-4xl space-y-8 animate-fade-in pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white border border-brand-100 rounded-2xl p-8 shadow-sm mt-8">
            <h2 className="text-xl font-bold text-brand-900 mb-6 flex items-center gap-3 border-b border-brand-50 pb-4">
              <span className="w-8 h-8 rounded-full bg-[#25D366]/10 flex items-center justify-center">
                <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="text-[#25D366]">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                <div>
                  <h4 className="font-bold text-gray-900">Bouton WhatsApp</h4>
                  <p className="text-sm text-gray-500 mt-1">Affiche un bouton flottant pour discuter avec vos clients.</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer shrink-0">
                  <input 
                    type="checkbox" 
              ...
              <div className={`${!settings.whatsappEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
                <label className="block text-sm font-medium text-brand-700 mb-2">Numéro de téléphone WhatsApp</label>
                <input 
                  type="text" 
                ...
                />
                <p className="text-xs text-brand-500 mt-2">Format international sans le "+" ou avec (ex: 21612345678).</p>
              </div>
            </div>
          </div>
        </div>
